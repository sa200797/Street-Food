...
{
    [CustomEditor(typeof(JMRNativeVideoPlayer))]
    public class JMRNativeVideoPlayerInspector : Editor
    {
        #region Editor Actions

        const string PrefabGUID = "3918ce9845987984da6dbd81895986bf";

        private static string PrefabPath => AssetDatabase.GUIDToAssetPath(PrefabGUID);

        [MenuItem("JioMixedReality/Toolkits/Common/Video Player/Native")]
